  ...
  return (
    <PageLayout menu={<SettingsMenu />} breadcrumbs={['settingsTitle', 'deviceTitle']}>
      ...
      <Box sx={{ width: '100%', overflowX: 'auto' }}>
        <Table className={classes.table} sx={{ minWidth: 920, tableLayout: 'fixed' }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell>
                <Stack spacing={1} sx={{ py: 0.5 }}>
                  <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
                    ...
                    <Button onClick={handleExport} variant="text" size="small">
                      {t('reportExport')}
                    </Button>
                  </Stack>
                  {selectedCount > 0 && (
                    ...
                    >
                      ...
                      <Button onClick={() => setSelectedDeviceIds([])} variant="text" size="small">
                        Clear selection
                      </Button>
                    </Stack>
                  )}
