  ...
  return (
    <PageLayout menu={<SettingsMenu />} breadcrumbs={['settingsTitle', 'deviceTitle']}>
      ...
      <Box sx={{ width: '100%', overflowX: 'auto' }}>
        <Table className={classes.table} sx={{ width: '100%', tableLayout: 'auto' }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell className={classes.columnAction} sx={{ width: 96, minWidth: 96 }} />
            </TableRow>
          </TableHead>
          <TableBody>
            {items.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell
                  ...
                  padding="none"
                  sx={{ width: 96, minWidth: 96, whiteSpace: 'nowrap' }}
                >
                  <CollectionActions
                    itemId={item.id}
                ...
                <Stack spacing={1} sx={{ py: 0.5 }}>
                  <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
                    ...
                    <Button
                      ...
                      size="small"
                      sx={{ whiteSpace: 'nowrap', minWidth: 85 }}
                    >
                      Import CSV
                    </Button>
                    <Button
